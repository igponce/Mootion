...
function openSpellChecker() {
  // get the textarea we're going to check
	...
	var textarea1 = document.getElementById('bodytext');
...
function openSpellCheckerVote() {
  // get the textarea we're going to check
	var textarea1 = document.getElementById('vote');
	var speller = new spellChecker( textarea1 );
	speller.openChecker();
}
...
function checkit(form) {
  url = 'checkusername?username='+form.username.value;
  ...
  checkitxmlhttp.onreadystatechange=function() {
	...
	document.getElementById('checkitvalue').innerHTML = '<span style="color:red">Username "'+form.username.value+'" is '+responsestring+'</span>';
	form.submit.disabled = 'disabled';
      } else {
	document.getElementById('checkitvalue').innerHTML = '<span style="color:black">Username "'+form.username.value+'" is '+responsestring+'</span>';
