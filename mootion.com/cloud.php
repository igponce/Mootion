...
global $range_names, $hdr_tagscloud, $msg_tags;
...
// localization // $range_names  = array( '48 horas',  'última semana', 'último mes', 'último año', 'todas');
...
do_header($hdr_tagscloud);
do_navbar($msg_tags);
echo '<div id="contents">';
echo '<h2>'. $msg_top100tags .'</h2>';
...
if ($res) {
	...
	foreach ($words as $word => $count) {
		...
		echo '<span style="font-size: '.$size.'pt"><a href="index.php?search='.urlencode($word).$time_query.'&amp;tag=true">'.$word.'</a></span>&nbsp;&nbsp; ';
	}
